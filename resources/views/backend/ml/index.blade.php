...
@section('content')
    ...
    <div class="page-header-content py-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between">
            ...
            <a href="/admin/auth/mercadolibre/auth" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form id="deleteForm" action="/admin/auth/mercadolibre/deleteContaML" method="POST" class="float-right">
                        @csrf
...
<script>
    $(document).ready(function() {
        $('.openModalButton').click(function() {
            ...
            $.ajax({
                type: 'GET',
                url: '/admin/auth/mercadolibre/getMLData',
                data: {
                    mlId: mlId
